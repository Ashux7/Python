...
dfSELL = pd.read_csv('D:\\ASHU\\codes\\Python\\school\\c12\\project\\tasmay\\tasmaySELL.csv',index_col='MedID')
dfPRC = pd.read_csv('D:\\ASHU\\codes\\Python\\school\\c12\\project\\tasmay\\tasmayPRC.csv',index_col='NID')
...
def tsmyMS():
        ...
        if choice == '1':
            ...
            for i in range(n):
                ...
                dfPRC.to_csv('D:\\ASHU\\codes\\Python\\school\\c12\\project\\tasmay\\tasmayPRC.csv')
